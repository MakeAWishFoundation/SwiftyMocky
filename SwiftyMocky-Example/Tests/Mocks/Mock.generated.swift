...
class ItemsClientMock: ItemsClient, Mock {
    ...
    func getExampleItems() -> Observable<[Item]> {
        addInvocation(.igetExampleItems)
		let perform = methodPerformValue(.igetExampleItems) as? () -> Void
		perform?()
		let value = methodReturnValue(.igetExampleItems) as? Observable<[Item]>
    ...
    func getItemDetails(item: Item) -> Observable<ItemDetails> {
        addInvocation(.igetItemDetails__item_item(.value(item)))
		let perform = methodPerformValue(.igetItemDetails__item_item(.value(item))) as? (Item) -> Void
		perform?(item)
		let value = methodReturnValue(.igetItemDetails__item_item(.value(item))) as? Observable<ItemDetails>
    ...
    func update(item: Item, withLimit limit: Decimal, expirationDate date: Date?) -> Single<Void> {
        addInvocation(.iupdate__item_itemwithLimit_limitexpirationDate_date(.value(item), .value(limit), .value(date)))
		let perform = methodPerformValue(.iupdate__item_itemwithLimit_limitexpirationDate_date(.value(item), .value(limit), .value(date))) as? (Item, Decimal, Date?) -> Void
		perform?(item, limit, date)
		let value = methodReturnValue(.iupdate__item_itemwithLimit_limitexpirationDate_date(.value(item), .value(limit), .value(date))) as? Single<Void>
    ...
    fileprivate enum MethodType {
        case igetExampleItems
        case igetItemDetails__item_item(Parameter<Item>)
        case iupdate__item_itemwithLimit_limitexpirationDate_date(Parameter<Item>, Parameter<Decimal>, Parameter<Date?>)

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            switch (lhs, rhs) {
                case (.igetExampleItems, .igetExampleItems): 
                    return true 
                case (.igetItemDetails__item_item(let lhsItem), .igetItemDetails__item_item(let rhsItem)): 
                    guard Parameter.compare(lhs: lhsItem, rhs: rhsItem, with: matcher) else { return false } 
                    return true 
                case (.iupdate__item_itemwithLimit_limitexpirationDate_date(let lhsItem, let lhsLimit, let lhsDate), .iupdate__item_itemwithLimit_limitexpirationDate_date(let rhsItem, let rhsLimit, let rhsDate)): 
                    guard Parameter.compare(lhs: lhsItem, rhs: rhsItem, with: matcher) else { return false } 
        ...
        func intValue() -> Int {
            switch self {
                case .igetExampleItems: return 0
                case let .igetItemDetails__item_item(p0): return p0.intValue
                case let .iupdate__item_itemwithLimit_limitexpirationDate_date(p0, p1, p2): return p0.intValue + p1.intValue + p2.intValue
            }
        }
    }
    ...
    struct Given {
        ...
        static func getExampleItems(willReturn: Observable<[Item]>) -> Given {
            return Given(method: .igetExampleItems, returns: willReturn, throws: nil)
        }
        static func getItemDetails(item: Parameter<Item>, willReturn: Observable<ItemDetails>) -> Given {
            return Given(method: .igetItemDetails__item_item(item), returns: willReturn, throws: nil)
        }
        static func update(item: Parameter<Item>, withLimit limit: Parameter<Decimal>, expirationDate date: Parameter<Date?>, willReturn: Single<Void>) -> Given {
            return Given(method: .iupdate__item_itemwithLimit_limitexpirationDate_date(item, limit, date), returns: willReturn, throws: nil)
        }
    }
    ...
    struct Verify {
        ...
        static func getExampleItems() -> Verify {
            return Verify(method: .igetExampleItems)
        }
        static func getItemDetails(item: Parameter<Item>) -> Verify {
            return Verify(method: .igetItemDetails__item_item(item))
        }
        static func update(item: Parameter<Item>, withLimit limit: Parameter<Decimal>, expirationDate date: Parameter<Date?>) -> Verify {
            return Verify(method: .iupdate__item_itemwithLimit_limitexpirationDate_date(item, limit, date))
        }
    }
    ...
    struct Perform {
        ...
        static func getExampleItems(perform: () -> Void) -> Perform {
            return Perform(method: .igetExampleItems, performs: perform)
        }
        static func getItemDetails(item: Parameter<Item>, perform: (Item) -> Void) -> Perform {
            return Perform(method: .igetItemDetails__item_item(item), performs: perform)
        }
        static func update(item: Parameter<Item>, withLimit limit: Parameter<Decimal>, expirationDate date: Parameter<Date?>, perform: (Item, Decimal, Date?) -> Void) -> Perform {
            return Perform(method: .iupdate__item_itemwithLimit_limitexpirationDate_date(item, limit, date), performs: perform)
        }
    }
...
class ItemsModelMock: ItemsModel, Mock {
    ...
    func getPrice(for item: Item) -> Decimal {
        addInvocation(.igetPrice__for_item(.value(item)))
		let perform = methodPerformValue(.igetPrice__for_item(.value(item))) as? (Item) -> Void
		perform?(item)
		let value = methodReturnValue(.igetPrice__for_item(.value(item))) as? Decimal
    ...
    fileprivate enum MethodType {
        case igetExampleItems
        case igetItemDetails__item_item(Parameter<Item>)
        case igetPrice__for_item(Parameter<Item>)
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            switch (lhs, rhs) {
                ...
                case (.igetItemDetails__item_item(let lhsItem), .igetItemDetails__item_item(let rhsItem)): 
                    guard Parameter.compare(lhs: lhsItem, rhs: rhsItem, with: matcher) else { return false } 
                    return true 
                case (.igetPrice__for_item(let lhsItem), .igetPrice__for_item(let rhsItem)): 
                    guard Parameter.compare(lhs: lhsItem, rhs: rhsItem, with: matcher) else { return false } 
                    return true 
                default: return false
            }
        ...
        func intValue() -> Int {
            switch self {
                case .igetExampleItems: return 0
                case let .igetItemDetails__item_item(p0): return p0.intValue
                case let .igetPrice__for_item(p0): return p0.intValue
            }
        }
    }
    ...
    struct Given {
        ...
        static func getPrice(for item: Parameter<Item>, willReturn: Decimal) -> Given {
            return Given(method: .igetPrice__for_item(item), returns: willReturn, throws: nil)
        }
    }
    ...
    struct Verify {
        ...
        static func getPrice(for item: Parameter<Item>) -> Verify {
            return Verify(method: .igetPrice__for_item(item))
        }
    }
    ...
    struct Perform {
        ...
        static func getPrice(for item: Parameter<Item>, perform: (Item) -> Void) -> Perform {
            return Perform(method: .igetPrice__for_item(item), performs: perform)
        }
    }
